...
//import org.nerdcore.phylactory.model.Combatant;
...
public class MainView extends JFrame {
    ...
    /**
     * Method to build the left-hand panel that holds buttons that implement other actions of this localview of the application
     *
     * @param party
     */
    private void buildButtonPanel(final Party party) {
        ...
        JButton addMonstersButton = new JButton("Add Monsters");
        ...
        g.gridy++;
        buttonPanel.add(addMonstersButton, g);
        ...
        addMonstersButton.addActionListener(e -> MainViewController.buildAddMonsterView());
    ...
    /**
     * Initializes key foundational Swing components for the localview that don't display or require specific party information
     */
